        ...
        {bucket && (
          <div className="absolute top-4 right-4 z-20">
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl bg-black/35 backdrop-blur-sm text-white/80 hover:text-white hover:bg-black/55 active:scale-[0.98] transition-transform duration-150"
              aria-label="목표 수정"
            >
